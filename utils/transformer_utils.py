...
""""
The function returns time series data for Transformer.
Params:
...
def get_transformer_data(file_path, l_seq, scale=True):
    ...
    if scale:
        ...
        input_scaled = input_scaler.fit_transform(input_scaled)
    ...
    if scale:
        ...
        output_scaled = output_scaler.fit_transform(output_scaled)
